          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-2xl font-bold text-white tracking-wide">
                Mendis<span className="text-blue-500">Computers</span>
              </h3>
            </div>

            <p className="text-sm text-gray-400 leading-relaxed">
              Premium computer hardware, accessories, and smart tech solutions.
              Powering your digital world with reliability and innovation.
            </p>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">
            © {new Date().getFullYear()} Mendis Computers. All rights reserved.
          </p>
